...
namespace shoot
{
	...
	void ToolbarManager::Init()
	{
		...
		// create the tool bar
		//wxToolBar* m_pMainToolbar = new wxToolBar(this, wxID_ANY);
		...
		m_pMainToolbar->AddTool(ID_Menu_Duplicate, wxT("Duplicate Entity"), wxArtProvider::GetBitmap(wxART_COPY), wxT("Duplicate Entity"));
		m_pMainToolbar->AddTool(ID_Menu_Remove, wxT("Delete Entity"), wxArtProvider::GetBitmap(wxART_DELETE), wxT("Delete Entity"));
		m_pMainToolbar->AddSeparator();
