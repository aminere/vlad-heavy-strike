...
namespace shoot
{
	const char* const OpenGLExtensionHandlerWin32::ms_strExtensionStrings[OpenGLExtensionHandlerWin32::E_Count] =
	{
		...
		"GL_ARB_texture_cube_map", // E_CubeMap
		"None", // "GL_ARB_point_sprite", // E_PointSprite // Disabled for consistency with DX11
		"GL_ARB_point_parameters", // E_PointParams
		"GL_ARB_vertex_buffer_object", // E_VBO
		"GL_ARB_vertex_array_object", // E_VAO
	...
	void OpenGLExtensionHandlerWin32::extGlClientActiveTexture(GLenum texture)
	{
		GL_CHECK(pGlClientActiveTextureARB(texture));
	}

	void OpenGLExtensionHandlerWin32::extGlPointParameterf(GLenum pname, GLfloat param)
	{
		GL_CHECK(pGlPointParameterfARB(pname, param));
	}

	void OpenGLExtensionHandlerWin32::extGlPointParameterfv(GLenum pname, const GLfloat *params)
	{
		GL_CHECK(pGlPointParameterfvARB(pname, params));
	}
	...
	bool OpenGLExtensionHandlerWin32::extGlCheckCompileStatus(GLuint shader)
	{
	...
	bool OpenGLExtensionHandlerWin32::extGlCheckLinkStatus(GLuint program)
	{
		GLint status = GL_TRUE;
	...
	void OpenGLExtensionHandlerWin32::extGlGetUniformLocation(GLuint program, const char* name, GLuint* location)
	{
		*location = GL_CHECK(pGlGetUniformLocationARB(program, name));
	}
	...
	{
		*location = GL_CHECK(pGlGetAttribLocationARB(program, name));
	}
