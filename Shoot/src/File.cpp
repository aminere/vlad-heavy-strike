...
namespace shoot
{
	...
	//! reads a string
	s32 File::Read(std::string& dest, char delim1 /*= 0*/, char delim2 /*= 0*/)
	{
		char c;
		while(Read(&c, 1))
		{
	...
	s32 File::ReadLine(char* pDest, u32 numChars, char delim /*= '\n'*/)
	{
		u32 i;
	...
	void File::Ignore(u32 numChars, char delimiter /*= ' '*/)
	{
