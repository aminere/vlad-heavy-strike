...
#ifndef _COLLISION_COMPONENT_H_INCLUDED_
#define _COLLISION_COMPONENT_H_INCLUDED_
...
namespace shoot
{
	...
	public:		
		...
		static const u32 NumCollisionGroups = 8;
		...
		inline f32 GetCollisionRadius() const { return m_fCollisionRadius; }
	...
	protected:
		...
		Mask m_Mask;
		u32 m_Priority;
		f32 m_fCollisionRadius;
	};
}

#endif // _COLLISION_COMPONENT_H_INCLUDED_
