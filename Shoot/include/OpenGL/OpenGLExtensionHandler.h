...
#ifndef _OPENGL_EXTENSION_HANDLER_H_INCLUDED_
#define _OPENGL_EXTENSION_HANDLER_H_INCLUDED_
...
namespace shoot
{
	...
	public:
		...
		virtual void extGlClientActiveTexture(GLenum texture) = 0;
		virtual void extGlPointParameterf(GLenum pname, GLfloat param) = 0;
		virtual void extGlPointParameterfv(GLenum pname, const GLfloat *params) = 0;
		...
		virtual bool extGlCheckCompileStatus(GLuint shader) = 0;
		virtual bool extGlCheckLinkStatus(GLuint program) = 0;
		virtual void extGlGetUniformLocation(GLuint program, const char* name, GLuint* location) = 0;
...
#endif // _OPENGL_EXTENSION_HANDLER_H_INCLUDED_
