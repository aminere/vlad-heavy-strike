...
#ifndef _INPUT_MANAGER_TOUCH_H_INCLUDED_
#define _INPUT_MANAGER_TOUCH_H_INCLUDED_
...
namespace shoot
{
	...
	public:
		...
		bool IsTouchJustReleased() const;
...
#endif // _INPUT_MANAGER_TOUCH_H_INCLUDED_
