...
namespace shoot
{
	...
	public:
		...
		enum E_NodeType
		{
			...
			//T_XnYp,
			//T_XpYp,
			T_Yn, // optimization for vertical scrolling space shooter
			T_Yp,
			T_Count
		};
	...
	public:
		...
		inline u32 GetNodesDrawn() const { return m_NodesDrawn; }
	...
	private:
		...
		std::map<Entity*, u32> m_ProcessedEntities;
